...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/0017464e722d799648a0b0694a3103f6.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/6446d2f4471602495081e385ebb57546.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/0f7534d10d3c9d151403ab4bfde52587.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/093586446110b2559b0dcc5b4dcae5c5.png)​

show engine innodb status 查看锁相关的部分：

​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/808c09996d29f3e749cf70194623cc10.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/0340451969c1b7239dcccdff886dcd2e.png)​

（2）不可重复读：在事务 A 中先后两次读取同一个数据，两次读取的结果不一样，这种现象称为不可重复读。脏读与不可重复读的区别在于：前者读到的是其他事务未提交的数据，后者读到的是其他事务已提交的数据。举例如下：

​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/7f8527b4790e213559871b3cedaccf5a.png)​

（3）幻读：在事务 A 中按照某个条件先后两次查询数据库，两次查询结果的条数不同，这种现象称为幻读。不可重复读与幻读的区别可以通俗的理解为：前者是数据变了，后者是数据的行数变了。举例如下：

​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/fedd3a66c06b0ce4bac6bdb781dd3116.png)​

### 4. 事务隔离级别

SQL 标准中定义了四种隔离级别，并规定了每种隔离级别下上述几个问题是否存在。一般来说，隔离级别越低，系统开销越低，可支持的并发越高，但隔离性也越差。隔离级别与读问题的关系如下：

​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/cb7dd700227a99d65c6fb7d3622081fa.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/15a0cc13cf6d5556e7bba6057383350b.png)​

​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/eff069175e98f9faf4f22d61196d3c8b.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/ade8237c9134e41eaa8726a6b6ff2936.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/597c95806deb2b9b2d82419659a564af.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/fbbea019294d8dc188b1f14a5502cff8.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/14210db7a06032ca64c51f11d6173b33.png)​
...
​![image](https://cdn.jsdelivr.net/gh/bookandmusic/static/image/2024-11/fc3411dfc456685ad289cbb7861847b1.png)​
